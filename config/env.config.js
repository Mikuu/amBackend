...
switch (process.env.MICOO_ENV) {
    case "docker":
        ...
        mongodbUrl = `mongodb://${process.env.MICOO_DB_USERNAME}:${process.env.MICOO_DB_PASSWORD}@micoo-mongodb:27088/micoo`;
    ...
    default:
        ...
        exchangeRootDir = "../exchange";
        mongodbUrl = `mongodb://${process.env.MICOO_DB_USERNAME}:${process.env.MICOO_DB_PASSWORD}@localhost:27088/micoo`;
        bulkCompareMemoryList = process.env.MICOO_COMP_MEM_LIMIT ? process.env.MICOO_COMP_MEM_LIMIT : 500;
        break;
}
